...
function ServicesSection() {
  ...
  useEffect(() => {
    if (document.querySelectorAll("ul.classfication-list li")[0]) {
      document
        .querySelectorAll("ul.classfication-list li")[0]
  ...
  useEffect(() => {
    let totalMinPrice = servicesAdded.reduce((acc, serv) => {
      serv.min_price
        ? (acc += serv.min_price * serv.quantity)
        : console.log("no");
      return acc;
    }, 0);
    setMinPrice(totalMinPrice);
    ...
    let totalMaxPrice = servicesAdded.reduce((acc, serv) => {
      serv.min_price
        ? (acc += serv.max_price * serv.quantity)
        : console.log("no");
      return acc;
    }, 0);
    setMaxPrice(totalMaxPrice);
        ...
        <div className="container services-container">
          ...
          <div className="row cards">
            <DepartmentCard
              ...
              selectionId={"Electricity"}
            />
            <DepartmentCard
              img={Carpentry}
              department_name="Carpentry"
              selectionId={"Carpentry"}
            />
            <DepartmentCard
              img={Plumbing}
              department_name="Plumbing"
              selectionId={"Plumbing"}
            />
            <DepartmentCard
              img={Painting}
              department_name="Painting"
              selectionId={"Painting"}
            />
            <DepartmentCard
              img={Conditioning}
              department_name="Conditioning"
              selectionId={"Conditioning"}
            />
            <DepartmentCard
              img={Cleaning}
              department_name="Cleaning"
              selectionId={"Cleaning"}
            />
            <DepartmentCard
              img={Satellite}
              department_name="Satellite & .."
              selectionId={"Satellite"}
            />
            <DepartmentCard
              img={Gypsum}
              className="gypsum"
              department_name="Gypsum Board"
              selectionId={"Carpentry"}
            />
            {/* "https://elasticbeanstalk-us-east-2-780758728594.s3.us-east-2.amazonaws.com/majors/Gypsum%20Board.png" */}
            <DepartmentCard
              img={Ceramic}
              department_name="Ceramic & Tiles"
              selectionId={"Ceramic"}
            />
            {/* "https://elasticbeanstalk-us-east-2-780758728594.s3.us-east-2.amazonaws.com/majors/Aluminum.png" */}
            <DepartmentCard
              img={Aluminum}
              department_name="Aluminum"
              selectionId={"Carpentry"}
            />
            <DepartmentCard
              img={Appliances}
              department_name="Appliances"
              selectionId={"Appliances"}
            />
            <DepartmentCard
              img={Sterilization}
              department_name="Sterilization & Disinfection"
              selectionId={"Sterilizatio"}
            />
            <DepartmentCard
              img={Pest}
              department_name="Pest Control"
              selectionId={"Pest-Control"}
            />
            {/* "https://elasticbeanstalk-us-east-2-780758728594.s3.us-east-2.amazonaws.com/majors/Pest%20Control.png" */}
            <DepartmentCard
              img={Plastering}
              department_name="Plastering"
              selectionId={"Plastering"}
            />
          </div>
        </div>
        ...
        <div className="parent-of-requests-popub">
          <div className="requests-popub">
            <div className="serv-title-and-close">
              ...
              <button
                className="close-serv-div"
                onClick={() => {
                  document
                    .querySelector(".close-request-ask")
                    .classList.add("active");
                }}
              >
                ...
                <div className="classfication-div">
                  <ul className="classfication-list">
                    {classFicationData.map((classFication) => {
                      return (
                        <li
                          data-o={classFication.cetogry}
                          key={classFication.item}
                          className={`item-service ${classFication.cetogry}`}
                          id={classFication.cetogry}
                          onClick={(e) => {
                            let allItems = document.querySelectorAll(
                              "ul.classfication-list li"
                            );
                            ...
                            let activeServices = document.querySelectorAll(
                              `.service-card.${e.target.classList[2]}`
                            );
            ...
            <div className="price-and-check-up">
              ...
              <button
                ...
                onClick={() => {
                  let empttCartPopub = document.querySelector(
              ...
              <div className="selection-btns">
                ...
                <button
                  ...
                  onClick={() => {
                    document
                      .querySelector(
                        ".services-section .parent-of-requests-popub"
                      )
                      .classList.remove("active");
                    document
                      .querySelector(".close-request-ask")
            ...
            <div className="head">
              <div className="text-and-go-back">
                <button
                  ...
                  onClick={() => {
                    document
                      .querySelector(".complete-req-div")
                      .classList.remove("active");
                  }}
                >
                        ...
                        <div className="service-div" key={serv.id}>
                          <div className="service-info">
                            ...
                            <p className="service-price">
                              {serv.min_price * serv.quantity} -{" "}
                              {serv.max_price * serv.quantity} EGP
                            </p>
                          </div>
                ...
                >
                  ...
                  <div className="order-date">
                    ...
                    <div className="input-div file-div">
                      <img
                        src="https://www.anamehani.com/img/camera.png"
                        alt=""
                      />
